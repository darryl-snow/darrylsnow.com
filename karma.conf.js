...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'client/bower_components/packery/js/rect.js',
      'client/bower_components/packery/js/packer.js',
      'client/bower_components/packery/js/item.js',
      'client/bower_components/packery/js/packery.js',
