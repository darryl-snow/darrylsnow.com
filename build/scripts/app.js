...
app = angular.module("darrylsnow", ["ngAnimate", "ui.router", "darrylsnow-intro", "templates"]).config([
...
app.controller("MainCtrl", [
  "$scope", "$state", "$stateParams", "packeryService", function($scope, $state, $stateParams, packeryService) {
    packeryService.initialise();
    return $scope.update = function() {
      return packeryService.update();
    };
  }
]);
...
},{"./global/packery-service.coffee":2,"./global/panel-directive.coffee":3,"./global/resize-panel-directive.coffee":4,"./intro/intro-controller.coffee":5,"./templates":6,"angular":9,"angular-animate":7,"angular-ui-router":8}],2:[function(require,module,exports){
"use strict";
angular.module("darrylsnow").provider("packeryService", function() {
    ...
    $get: [
      "$rootScope", (function(_this) {
        return function($rootScope) {
          var initialise, update;
          initialise = function() {
            return _this.packery = new Packery(_this.container, {
              itemSelector: _this.selector,
              gutter: _this.gutter,
              transitionDuration: _this.transition
            });
          };
          update = function() {
...
angular.module("darrylsnow").directive("panel", function() {
  ...
  link = function(scope, element, attrs) {
    ...
    return element[0].style.width = element[0].clientWidth + "px";
  };
  return {
    restrict: "C",
    link: link
...
"use strict";
angular.module("darrylsnow").directive("resizePanel", [
  "packeryService", function(packeryService) {
    var link;
    link = function(scope, element, attrs) {
      return element.on("click", function() {
        ...
        for (_i = 0, _len = items.length; _i < _len; _i++) {
          item = items[_i];
          if (angular.element(item)[0] !== element.parent()[0]) {
          ...
          return setTimeout(function() {
            ...
            return setTimeout(function() {
              ...
              for (_j = 0, _len1 = items.length; _j < _len1; _j++) {
                item = items[_j];
                _results.push(item.style.opacity = "1");
              }
              return _results;
            }, 250);
          }, 250);
...
app = angular.module("darrylsnow-intro", ["ui.router"]).config(["$stateProvider", "$urlRouterProvider", function($stateProvider, $urlRouterProvider) {}]);

app.controller("IntroCtrl", [
  "$scope", "$state", "$stateParams", function($scope, $state, $stateParams, $route) {
...
},{"./lib/angular.min.js":10}],10:[function(require,module,exports){
/*
 AngularJS v1.2.16
 (c) 2010-2014 Google, Inc. http://angularjs.org
 License: MIT
