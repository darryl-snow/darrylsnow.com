...
app = angular.module("darrylsnow", ["ngAnimate", "ngRoute", "ui.router", "darrylsnow-skills", "darrylsnow-intro", "templates"]).config([
  "$routeProvider", "$stateProvider", "$urlRouterProvider", "$locationProvider", function($routeProvider, $stateProvider, $urlRouterProvider, $locationProvider) {
...
},{"./intro/intro-controller.coffee":2,"./skills/skills-controller.coffee":3,"./templates":4,"angular":8,"angular-animate":5,"angular-route":6,"angular-ui-router":7}],2:[function(require,module,exports){
"use strict";
var app;

app = angular.module("darrylsnow-intro", ["ngRoute", "ui.router"]).config([
  "$stateProvider", "$urlRouterProvider", "$routeProvider", function($stateProvider, $urlRouterProvider, $routeProvider) {
    return $stateProvider.state("main.intro", {
...
app.controller("IntroCtrl", [
  "$scope", "$state", "$stateParams", "$route", function($scope, $state, $stateParams, $route) {
    console.log("intro");
...
app = angular.module("darrylsnow-skills", ["ngRoute", "ui.router"]).config(["$stateProvider", "$urlRouterProvider", "$routeProvider", function($stateProvider, $urlRouterProvider, $routeProvider) {}]);
...
angular.module("templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("scripts/panels.html","<div class=\"panels\"><div data-ng-include=\"\'scripts/intro/intro.html\'\" data-ng-controller=\"IntroCtrl\"></div><div data-ng-include=\"\'scripts/skills/skills.html\'\" data-ng-controller=\"SkillsCtrl\"></div></div>");
$templateCache.put("scripts/intro/intro.html","<div class=\"panel\"><p>Intro</p><a href=\"/intro\">maximise</a><p>{{maximised}}</p></div>");
